//Ajout des pointeurs intelligents
#include <iostream>
#include <utility>
#include <memory>
using namespace std;
...
public:
	Matrice(int hauteur=3, int largeur=3) {
		hauteur_ = hauteur;
		largeur_ = largeur;
		données_ = make_unique<double[]>(largeur*hauteur);
...
int main(int argc, char* argv[])
{
	...
	cout << "La talle de la matrice est: " << largeur << " x " << hauteur << endl;
	return 0;
}
